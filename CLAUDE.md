...
⬜ Briefing Agent    Claude API (claude-sonnet-4-6) + edge/Kelly email (C13 disclaimer) over the predictions M1b writes; RAG deferred (qdrant store unbuilt). See spec.md

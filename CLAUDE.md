...
⬜ Orchestrator wiring  DI adapter-factory wiring + cron shim → DailyPipeline.run_once() + sequential multi-agent loop under one run_id (thin, deferred). Owns §N5 email-delivery idempotency/outbox.

...
│   └── versions/001..009 + 011..013_*.py # see §3, §H (no 010); 013 = briefing_deliveries (§S5)
├── src/tennis/
...
│   └── composition.py         # §S7 — build_training_chain / build_daily_chain (DI: AppConfig + env → adapters/clients/agents)
└── tests/
    ├── conftest.py            # frozen_clock, repo_root, config_path
    ├── unit/                  # 1221 tests, all green locally
